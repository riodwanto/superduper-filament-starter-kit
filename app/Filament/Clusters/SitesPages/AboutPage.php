...
class AboutPage extends Page implements HasForms
{
    ...
    public function mount(): void
    {
        ...
        if (! auth()->user()->can('page_AboutPage')) {
    ...
    protected function loadFileContent(): void
    {
        try {
            ...
            if (File::exists($mainFilePath)) {
                ...
                Log::warning("About page file not found: {$mainFilePath}");
            }
        } catch (Exception $e) {
    ...
    public function save(): void
    {
        try {
            ...
            Notification::make()
                ...
                ->body('The about page content has been updated.')
                ->success()
                ->send();
        ...
        return <<<'HTML'
            <div class="container px-4 py-8 mx-auto">
                <div class="text-center">
                    ...
                    <p class="text-lg text-gray-600">This is your about page content. Edit this content from the admin panel.</p>
                </div>
            </div>
        HTML;
    }
    ...
    {
        return auth()->user()?->can('page_AboutPage') ?? false;
    }
