...
class ComingSoonPage extends Page implements HasForms
{
    ...
    public function mount(): void
    {
        ...
        if (! auth()->user()->can('page_ComingSoonPage')) {
    ...
    public function save(): void
    {
        ...
        try {
            ...
            Notification::make()
                ...
                ->body('The coming soon page content has been updated.')
                ->success()
                ->send();
        ...
        return <<<'HTML'
            <div class="container px-4 py-8 mx-auto">
                <div class="text-center">
                    ...
                    <p class="text-lg text-gray-600">This is your coming soon page content. Edit this content from the admin panel.</p>
                </div>
            </div>
        HTML;
    }
    ...
    {
        return auth()->user()?->can('page_ComingSoonPage') ?? false;
    }
    ...
    {
        return 'Coming Soon Page Editor';
    }
    ...
    {
        return 'Manage your website\'s coming soon page content.';
    }
